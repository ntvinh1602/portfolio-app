...
> = {
  content: {
    ...
    trigger: [
      ...
      "after:bg-amber-400 after:opacity-0 hover:after:opacity-80",
      ...
      "data-[state=active]:after:opacity-80",
  ...
  switch: {
    ...
    indicator:
      "rounded-2xl border border-primary bg-primary/15",
    list:
      "flex gap-1 p-0 rounded-2xl backdrop-blur-md border",
  },
}
