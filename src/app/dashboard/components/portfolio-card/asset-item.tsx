...
export function Asset({
  ...
  return (
    <Card.Root className="border-0 text-card-foreground bg-muted dark:bg-muted/50 backdrop-blur-sm rounded-xl py-3 before:content-[''] before:absolute before:top-0 before:left-1/2
