...
create or replace view "public"."monthly_snapshots" WITH ("security_invoker"='on') as  WITH month_ranges AS (
...
create or replace view "public"."yearly_snapshots" WITH ("security_invoker"='on') as  WITH vn_asset AS (
         SELECT assets.id
           FROM public.assets
...
create materialized view "public"."recaps_data" as  WITH stock_base AS (
