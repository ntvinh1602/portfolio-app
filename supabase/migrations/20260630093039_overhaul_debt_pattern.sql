create type "public"."stock_ops" as enum ('buy', 'sell');

drop trigger if exists "tx_legs_after_tx_debt" on "public"."tx_debt";

drop trigger if exists "tx_legs_after_tx_cashflow" on "public"."tx_cashflow";

drop trigger if exists "tx_legs_after_tx_stock" on "public"."tx_stock";

drop index if exists "public"."daily_snapshots_date_user_uidx";

drop function if exists "public"."create_tx_cashflow_legs"();

drop function if exists "public"."create_tx_debt_legs"();

drop function if exists "public"."create_tx_stock_legs"();

drop function if exists "public"."process_tx_debt"(p_tx_id uuid);
...
create type "public"."tx_category" as enum ('stock', 'cashflow', 'debt', 'borrow', 'repay');


  create table "public"."tx_borrow" (
    "tx_id" uuid not null,
...
alter table "public"."tx_borrow" enable row level security;
  ...
  create table "public"."tx_repay" (
    "tx_id" uuid not null,
    "borrow_tx" uuid not null,
    "principal" numeric not null,
    "interest" numeric not null,
    "net_proceed" numeric not null generated always as ((principal + interest)) stored
      );
...
alter table "public"."news_article_assets" drop column "created_at";

alter table "public"."news_articles" drop column "created_at";

alter table "public"."refresh_queue" alter column "created_at" set not null;

alter table "public"."tx_entries" alter column "user_id" set not null;

alter table public.tx_stock drop column net_proceed;

ALTER TABLE public.tx_stock 
  ALTER COLUMN operation TYPE public.stock_ops using operation::public.stock_ops;

alter table "public"."tx_stock" add column "net_proceed" numeric generated always as (
CASE
...
alter table "public"."tx_stock" alter column "net_proceed" set not null;

alter table "public"."tx_stock" alter column "operation" set not null;

CREATE UNIQUE INDEX tx_borrow_pkey ON public.tx_borrow USING btree (tx_id);

CREATE UNIQUE INDEX tx_repay_pkey ON public.tx_repay USING btree (tx_id);

alter table "public"."tx_borrow" add constraint "tx_borrow_pkey" PRIMARY KEY using index "tx_borrow_pkey";

alter table "public"."tx_repay" add constraint "tx_repay_pkey" PRIMARY KEY using index "tx_repay_pkey";

alter table "public"."tx_borrow" add constraint "tx_borrow_tx_id_fkey" FOREIGN KEY (tx_id) REFERENCES public.tx_entries(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."tx_borrow" validate constraint "tx_borrow_tx_id_fkey";

alter table "public"."tx_repay" add constraint "tx_repay_borrow_tx_fkey" FOREIGN KEY (borrow_tx) REFERENCES public.tx_borrow(tx_id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."tx_repay" validate constraint "tx_repay_borrow_tx_fkey";

alter table "public"."tx_repay" add constraint "tx_repay_tx_id_fkey" FOREIGN KEY (tx_id) REFERENCES public.tx_entries(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."tx_repay" validate constraint "tx_repay_tx_id_fkey";

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION public.process_tx_borrow(p_tx_id uuid)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
...
CREATE OR REPLACE FUNCTION public.process_tx_repay(p_tx_id uuid)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.trg_process_tx_borrow()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.trg_process_tx_cashflow()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.trg_process_tx_repay()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.trg_process_tx_stock()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
grant delete on table "public"."tx_borrow" to "anon";

grant insert on table "public"."tx_borrow" to "anon";

grant references on table "public"."tx_borrow" to "anon";

grant select on table "public"."tx_borrow" to "anon";

grant trigger on table "public"."tx_borrow" to "anon";

grant truncate on table "public"."tx_borrow" to "anon";

grant update on table "public"."tx_borrow" to "anon";

grant delete on table "public"."tx_borrow" to "authenticated";

grant insert on table "public"."tx_borrow" to "authenticated";

grant references on table "public"."tx_borrow" to "authenticated";

grant select on table "public"."tx_borrow" to "authenticated";

grant trigger on table "public"."tx_borrow" to "authenticated";

grant truncate on table "public"."tx_borrow" to "authenticated";

grant update on table "public"."tx_borrow" to "authenticated";

grant delete on table "public"."tx_borrow" to "service_role";

grant insert on table "public"."tx_borrow" to "service_role";

grant references on table "public"."tx_borrow" to "service_role";

grant select on table "public"."tx_borrow" to "service_role";

grant trigger on table "public"."tx_borrow" to "service_role";

grant truncate on table "public"."tx_borrow" to "service_role";

grant update on table "public"."tx_borrow" to "service_role";

grant delete on table "public"."tx_repay" to "anon";

grant insert on table "public"."tx_repay" to "anon";

grant references on table "public"."tx_repay" to "anon";

grant select on table "public"."tx_repay" to "anon";

grant trigger on table "public"."tx_repay" to "anon";

grant truncate on table "public"."tx_repay" to "anon";

grant update on table "public"."tx_repay" to "anon";

grant delete on table "public"."tx_repay" to "authenticated";

grant insert on table "public"."tx_repay" to "authenticated";

grant references on table "public"."tx_repay" to "authenticated";

grant select on table "public"."tx_repay" to "authenticated";

grant trigger on table "public"."tx_repay" to "authenticated";

grant truncate on table "public"."tx_repay" to "authenticated";

grant update on table "public"."tx_repay" to "authenticated";

grant delete on table "public"."tx_repay" to "service_role";

grant insert on table "public"."tx_repay" to "service_role";

grant references on table "public"."tx_repay" to "service_role";

grant select on table "public"."tx_repay" to "service_role";

grant trigger on table "public"."tx_repay" to "service_role";

grant truncate on table "public"."tx_repay" to "service_role";

grant update on table "public"."tx_repay" to "service_role";
...
with check (true);
  ...
  create policy "Users can read their own borrow txs"
  on "public"."tx_borrow"
  as permissive
  for select
  to authenticated
...
with check (true);
  ...
  create policy "Users can read their own repay txs"
  on "public"."tx_repay"
  as permissive
  for select
  to authenticated
...
CREATE TRIGGER tx_legs_after_tx_borrow AFTER INSERT ON public.tx_borrow FOR EACH ROW EXECUTE FUNCTION public.trg_process_tx_borrow();

CREATE TRIGGER tx_legs_after_tx_repay AFTER INSERT ON public.tx_repay FOR EACH ROW EXECUTE FUNCTION public.trg_process_tx_repay();

CREATE TRIGGER tx_legs_after_tx_cashflow AFTER INSERT ON public.tx_cashflow FOR EACH ROW EXECUTE FUNCTION public.trg_process_tx_cashflow();

CREATE TRIGGER tx_legs_after_tx_stock AFTER INSERT ON public.tx_stock FOR EACH ROW EXECUTE FUNCTION public.trg_process_tx_stock();
