...
DROP FUNCTION IF EXISTS "public"."handle_deposit_transaction"(p_user_id uuid, p_transaction_date date, p_account_id uuid, p_quantity numeric, p_description text, p_asset_id uuid);
