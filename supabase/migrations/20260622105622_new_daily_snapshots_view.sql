drop index if exists "public"."daily_snapshots_snapshot_date_idx";
...
alter table "public"."historical_fxrate" drop constraint "exchange_rates_pkey";

alter table "public"."historical_prices" drop constraint "daily_security_prices_pkey";

drop index if exists "public"."daily_security_prices_pkey";

drop index if exists "public"."exchange_rates_pkey";

CREATE UNIQUE INDEX daily_security_prices_pkey ON public.historical_prices USING btree (asset_id, date) INCLUDE (close);

CREATE UNIQUE INDEX exchange_rates_pkey ON public.historical_fxrate USING btree (currency_code, date) INCLUDE (rate);

alter table "public"."historical_fxrate" add constraint "exchange_rates_pkey" PRIMARY KEY using index "exchange_rates_pkey";

alter table "public"."historical_prices" add constraint "daily_security_prices_pkey" PRIMARY KEY using index "daily_security_prices_pkey";

create or replace view "public"."daily_snapshots" as  WITH dates AS (
...
create or replace view "public"."monthly_snapshots" as  WITH month_ranges AS (
...
create or replace view "public"."yearly_snapshots" as  WITH vn_asset AS (
         SELECT assets.id
           FROM public.assets
...
create or replace view "public"."dashboard_data" as  WITH periods AS (
...
create or replace view "public"."reports_data" as  WITH stock_base AS (
