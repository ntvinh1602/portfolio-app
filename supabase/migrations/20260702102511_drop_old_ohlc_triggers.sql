...
ALTER TABLE "public"."m1_intraday_close" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."m1_intraday_close"
...
CREATE OR REPLACE TRIGGER "trg_upsert_historical_prices" AFTER INSERT ON "public"."m1_intraday_close" FOR EACH ROW EXECUTE FUNCTION "public"."upsert_historical_prices"();



CREATE OR REPLACE TRIGGER "tx_legs_after_tx_borrow" AFTER INSERT ON "public"."tx_borrow" FOR EACH ROW EXECUTE FUNCTION "public"."trg_process_tx_borrow"();



CREATE OR REPLACE TRIGGER "tx_legs_after_tx_cashflow" AFTER INSERT ON "public"."tx_cashflow" FOR EACH ROW EXECUTE FUNCTION "public"."trg_process_tx_cashflow"();



CREATE OR REPLACE TRIGGER "tx_legs_after_tx_repay" AFTER INSERT ON "public"."tx_repay" FOR EACH ROW EXECUTE FUNCTION "public"."trg_process_tx_repay"();



CREATE OR REPLACE TRIGGER "tx_legs_after_tx_stock" AFTER INSERT ON "public"."tx_stock" FOR EACH ROW EXECUTE FUNCTION "public"."trg_process_tx_stock"();
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."tx_borrow" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."tx_repay" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Enable insert for users based on user_id" ON "public"."tx_entries" FOR INSERT WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
GRANT ALL ON TABLE "public"."m1_intraday_close" TO "anon";
GRANT ALL ON TABLE "public"."m1_intraday_close" TO "authenticated";
GRANT ALL ON TABLE "public"."m1_intraday_close" TO "service_role";
