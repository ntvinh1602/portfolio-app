ALTER TABLE "public"."tax_lots" ALTER COLUMN "cost_basis" SET DEFAULT 0;

ALTER TYPE "public"."tax_lot_origin" ADD VALUE IF NOT EXISTS 'deposit';

DROP FUNCTION IF EXISTS "public"."handle_deposit_transaction"(p_user_id uuid, p_transaction_date date, p_account_id uuid, p_amount numeric, p_quantity numeric, p_description text, p_asset_id uuid);
