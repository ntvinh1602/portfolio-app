drop function if exists "public"."get_equity_chart_data"("uuid", "date", "date", integer);
...
-- Wrapper function with extended ranges
...
BEGIN
  FOREACH label IN ARRAY ranges LOOP
    ...
    RETURN QUERY
    SELECT label, s.date, s.net_equity_value
