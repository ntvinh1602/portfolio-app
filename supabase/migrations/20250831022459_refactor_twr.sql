...
CREATE OR REPLACE FUNCTION "public"."get_pnl"("p_user_id" "uuid") RETURNS TABLE("range_label" "text", "pnl" numeric)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
BEGIN
  FOREACH label IN ARRAY ranges LOOP
    ...
    -- Call the single-range function and attach the label
    RETURN QUERY
    SELECT label, public.calculate_pnl(p_user_id, start_date, end_date);
  END LOOP;
END;
$$;


ALTER FUNCTION "public"."get_pnl"("p_user_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_twr"("p_user_id" "uuid") RETURNS TABLE("range_label" "text", "twr" numeric)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_twr"("p_user_id" "uuid") OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."get_pnl"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_pnl"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_pnl"("p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_twr"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_twr"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_twr"("p_user_id" "uuid") TO "service_role";
