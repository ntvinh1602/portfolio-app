...
ALTER FUNCTION "public"."get_performance_benchmark_data"("p_user_id" "uuid", "p_start_date" "date", "p_end_date" "date") OWNER TO "postgres";
...
BEGIN
    ...
    IF v_asset_class = 'cash' AND v_asset_currency_code != 'VND' THEN
...
GRANT ALL ON FUNCTION "public"."get_performance_benchmark_data"("p_user_id" "uuid", "p_start_date" "date", "p_end_date" "date") TO "anon";
GRANT ALL ON FUNCTION "public"."get_performance_benchmark_data"("p_user_id" "uuid", "p_start_date" "date", "p_end_date" "date") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_performance_benchmark_data"("p_user_id" "uuid", "p_start_date" "date", "p_end_date" "date") TO "service_role";
