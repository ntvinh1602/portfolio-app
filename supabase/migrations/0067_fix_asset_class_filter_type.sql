-- Drop the existing function to redefine it with the correct type casting
DROP FUNCTION IF EXISTS public.get_transaction_feed(integer, integer, date, date, text);

-- Recreate the function with the correct type casting for the asset_class_filter parameter
